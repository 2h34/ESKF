...
$$
\boxed{\text{Gyro Error}\rightarrow
Integration
\rightarrow\text{Attitude Error Accumulation}\rightarrow
Drift
}
$$
...
\boxed{
F
=\text{State propagation relationship}}
$$
...
$$
\boxed{
H:\text{State Space}\rightarrow\text{Measurement Space}}
$$
...
\boxed{
S
=\text{Prediction uncertainty in measurement space}+\text{Measurement uncertainty}}
$$
...
$$
\boxed{\text{Quaternion Prediction}+\text{Error State}+
EKF
+
FAST\text{-}LIO\text{ Attitude Observation}}
$$
...
$$
\boxed{
\text{6D Attitude}\ Error\text{-}\text{State EKF}
}
$$
